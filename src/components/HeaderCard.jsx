...
const HeaderCard = () => {
  return (
    <div className='bg-base-300 w-12/13 rounded-lg min-h-55 p-6 mt-16 flex flex-col md:flex-row items-center md:items-start shadow-lg z-10 max-[420px]:p-4 max-[420px]:mt-12'>
      <img className='AH-Pulse rounded-3xl w-40 h-40 md:w-65 md:h-65 object-cover mb-6 md:mb-0 md:mr-8 border-4 border-primary mx-auto md:mx-0 self-center max-[420px]:w-32 max-[420px]:h-32' src="/assets/revilo.png" alt="Revilo.Dev Icon" />
